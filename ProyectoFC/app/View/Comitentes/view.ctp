<!-- File: /app/View/Comitente/view.ctp -->

<h1>Comitente</h1>
<p><?php echo h($comitente['Comitente']['nombre']); ?></p>
<p><?php echo h($comitente['Comitente']['responsable']); ?></p>
<p><?php echo h($comitente['Comitente']['cuit']); ?></p>
